...
src_install() {
	...
	if compgen -G 'usr/share/man/man1/*' > /dev/null; then
		doman usr/share/man/man1/*
	fi
	if [[ -f usr/share/doc/denial/README.md ]]; then
		dodoc usr/share/doc/denial/README.md
	fi
	if [[ -f usr/share/doc/denial/copyright ]]; then
		dodoc usr/share/doc/denial/copyright
	fi
